...
def Histogram(data1, data2, path, testType, science=True):
    # Spike Count
    ...
    plt.savefig(fname=path + '/' + f'histogram - Similarity Distribution of {testType} - Test Spike Count', )
    plt.close()
    ...
    plt.gca().yaxis.set_major_formatter(PercentFormatter(1))
    plt.savefig(fname=path + '/' + f'histogram - Similarity Distribution of {testType} - Test Dynamic Time Warping', )
    plt.close()
